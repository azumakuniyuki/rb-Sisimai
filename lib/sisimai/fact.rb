  ...
  class Fact
    ...
    def self.rise(**argvs)
      ...
      while e = deliveries.shift do
        ...
        ea = %w[
          action decodedby deliverystatus diagnosticcode diagnostictype feedbacktype lhost listid
          messageid origin reason replycode rhost smtpcommand subject
        ]
    ...
    def damn
      data = {}
      stringdata = %w[
        action alias catch decodedby deliverystatus destination diagnosticcode diagnostictype
        feedbacktype lhost listid messageid origin reason replycode rhost senderdomain smtpcommand
